...
const DEFAULT_IMAGE_URL = "https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIyLTA4L3JtNTU4LWVsZW1lbnRzLXdvcmQtMDEteC5qcGc.jpg";

function UpdateCoatNewForm() {
        ...
        <div className="New">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <select
                    ...
                    required
                >
                    <option value="Type of Coat">Choose Type of Coat</option>
                ...
                <select
                    ...
                    required
                >
                    <option value="Coat Size">Choose Coat Size</option>
...
export default UpdateCoatNewForm;
